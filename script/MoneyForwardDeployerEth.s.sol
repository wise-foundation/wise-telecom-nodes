...
contract MoneyForwardDeployerEth is Script {
    ...
    address constant OLD_VAULT_USDC = 0x11cEeE394842d9492f2C97050f66dE0e3f89D3A6;

    address constant OLD_VAULT_USDT = 0x3Ed1f16BbE0eE2C58119c13517a88fe9ccedfd45;

    address constant OLD_QUE_USDC   = 0x4e601103590b8971c208bF06B64ba1ef1c85B7e6;

    address constant OLD_QUE_USDT   = 0x0f63bDcE0f4f3531117E2ed2FE1484c5E40a75b5;
        ...
        returns (DeploymentContext memory ctx)
    {
        string memory file = isUsdc
            ? "data/USDCaddress_balances_eth.txt"
            : "data/USDTaddress_balances_eth.txt";
    ...
    {
        return isUsdc
            ? "data/que_state_eth_usdc.txt"
            : "data/que_state_eth_usdt.txt";
    }
        ...
        internal
    {
        ...
        string memory name = ctx.isUsdc
            ? "RWA WORLD MOBILE VAULT ERC20 USDC"
            : "RWA WORLD MOBILE VAULT ERC20 USDT";

        string memory symbol = ctx.isUsdc ? "RWAWMVERC20USDC" : "RWAWMVERC20USDT";
    ...
    {
        console2.log(
            "Deployment complete on ETH mainnet",
